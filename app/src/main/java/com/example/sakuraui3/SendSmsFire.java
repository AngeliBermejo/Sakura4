...
public class SendSmsFire extends Activity {
    Button sendBtn;
    EditText txtphoneNo;
    EditText txtMessage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sendsmsfire);
        ...
        sendBtn = (Button) findViewById(R.id.btnFire);
        txtphoneNo = (EditText) findViewById(R.id.editFire1);
        txtMessage = (EditText) findViewById(R.id.editFire2);
