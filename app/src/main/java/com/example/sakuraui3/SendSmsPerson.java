...
public class SendSmsPerson extends Activity {
    Button sendBtn;
    EditText txtphoneNo;
    EditText txtMessage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sendsmsperson);
        ...
        sendBtn = (Button) findViewById(R.id.btnPerson);
        txtphoneNo = (EditText) findViewById(R.id.editPerson1);
        txtMessage = (EditText) findViewById(R.id.editPerson2);
        String cellphone = "09177926032;09157518432"; //cellphone numbers
        txtphoneNo.setText(cellphone);
        txtMessage.setText("There is a person trapped at");
